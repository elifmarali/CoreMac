      ...
      <div className='containerMap'>
        <div className="mapAndListContainer">
          ...
          <div className="listContainer">
            ...
            <div className="addressContainer"> {/* Adres stil değeri eklendi */}
              <FaMapMarkerAlt className="locationIcon" />
              <p className="addressText">Esenkent, Dudullu Osb Mah, Nato Yolu Cd 265/ 1, 34775 Ümraniye/İstanbul</p>
            </div>

            <button className="faqButton" onClick={handleFaqClick}>Sıkça Sorulan Sorular</button>
          </div>
        </div>
      </div>
      <Footer />
